# ScreenDance Miami Festival 2027 — final application packet

Use this packet for the live Submittable form. It separates facts already established by the project from fields only the applicant can truthfully supply. Do not submit the older 5:13 engineering proof.

## Submission identity

| Form field | Copy-ready answer | Status |
|---|---|---|
...
Anthony J. Padavano is a multimedia artist, writer, educator and programmer whose work crosses photography, software, music and narrative systems. He has taught writing and literature at colleges in Florida, New York and Texas. His visual work begins from the idea that a photograph records the place a camera stood, and that depth, motion and a body can be recovered from enough of those records. He writes the software his images are made with and treats the program and photograph as one object rather than two. THE THING WITHOUT A NAME grows from a photographic study begun in 2017.
...
Applicant attestation supplied 31 August 2026: permission from the dancer was granted when the photographs were made; the pictured posters and objects are part of the photographed environment. The visual corpus is photographed by Anthony J. Padavano. The Delibes compositions are public domain; the named Paul De Bra source arrangements are used under CC BY 4.0; the project-authored MIDI performance uses the MIT-licensed MuseScore General soundfont. The applicant must personally accept the portal's rights warranty for the exact uploaded film and selected stills.
...
The progressive public control surface in PR #43; the typed terminal release evidence in draft PR #48; spatial/private apartment sound; venue/projector specifications; installation calibration and recovery; public website, press kit and pitch deck; archive and private-custody reclamation; selected-film master/DCP re-export. None replaces today's final Vimeo screener, form fields, stills, rights warranty or receipt.
