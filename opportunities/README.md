...
`omega-20260829.json` is the current immutable successor snapshot for the Alpha →
Omega release. It supersedes, but does not rewrite, `omega-20260826-2.json`,
`omega-20260826.json`, or the preserved August 4
...
and `omega-20260829.receipt.json` binds the current snapshot. Response bodies are not
