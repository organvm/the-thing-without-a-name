...
| The repository names Anthony J. Padavano as project artist and Madison Garber as performer and primary choreographer, while recording separate rights and implementation-attribution boundaries | Current repository attribution | [`danse-attribution-boundaries.json`](assertions/danse-attribution-boundaries.json), [`../../press/public_credits.md`](../../press/public_credits.md), release and rights records | Attribution language does not itself establish performer release, music clearance, pictured-object clearance, publication approval, or a granular implementation-contribution ledger |
